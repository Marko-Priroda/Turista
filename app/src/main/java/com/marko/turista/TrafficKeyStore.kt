...
class TrafficKeyStore(context: Context) {
    private val prefs = context.getSharedPreferences("traffic_credentials", Context.MODE_PRIVATE)
    private val alias = "turista_traffic_key"
