...
class PlantNetKeyStore(context: Context) {
    private val prefs = context.getSharedPreferences("plantnet_credentials", Context.MODE_PRIVATE)
    private val alias = "turista_plantnet_key"
